...
RUN dnf install -y clamav clamav-update amavis perl-Digest-SHA1 perl-IO-stringy telnet net-tools iputils
...
ADD Scripts/clean_amavis_log.sh /clean_amavis_log.sh
